...
export default function ScrollIcons() {
    ...
    return(
        <>
            ...
            <div className="sm:hidden animate-bounce opacity-60 flex flex-col gap-1.5">

                <div className="flex">
                    <div className={styles.mobileScrollAnime1} />
                    <div className={styles.mobileScrollAnime2} />
                </div>
            ...
            <div className="sm:flex items-center gap-5 opacity-60 hidden">
